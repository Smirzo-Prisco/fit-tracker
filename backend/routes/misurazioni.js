...
// Un campo lasciato vuoto nel form arriva come '' (non undefined/null): su
// una colonna DECIMAL MySQL rifiuta la stringa vuota (ER_TRUNCATED_WRONG_VALUE_FOR_FIELD),
// va quindi normalizzata a NULL prima dell'INSERT/UPDATE.
const normalizza = (v) => (v === undefined || v === null || v === '' ? null : v);
...
router.post('/', async (req, res) => {
  const valori = CAMPI.map((campo) => normalizza(req.body[campo]));
